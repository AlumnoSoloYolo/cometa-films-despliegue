...
export class LandingPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  cinematicImages = {
    sphere1: [
      ...
      { url: '', title: 'Citizen Kane', opacity: 0, isVisible: false },
    ...
    sphere2: [
      { url: 'https://static.nuso.org/media/cache/9d/36/9d36ab92f1de39e7e8dc389b0f908bc0.jpg', title: 'Pulp Fiction', opacity: 0, isVisible: false },
       { url: 'p', title: 'Citizen Kane', opacity: 0, isVisible: false },
    ...
    sphere8: [
      { url: 'https://andro4all.com/hero/2025/04/american-psycho.jpg?width=768&aspect_ratio=16:9&format=nowebp', title: 'Fight Club', opacity: 0, isVisible: false },
       { url: 'p', title: 'Citizen Kane', opacity: 0, isVisible: false },
      { url: 'https://imagenes.heraldo.es/files/image_1920_1080/uploads/imagenes/2017/12/19/_4EdwardScissorhands_fd9bd1be.jpg', title: 'Forrest Gump', opacity: 0, isVisible: false },
       { url: 'p', title: 'Citizen Kane', opacity: 0, isVisible: false },
